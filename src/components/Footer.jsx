        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start sm:items-center md:items-start">
            ...
            <ul className="space-y-1">
              {['Emergency Care', 'Outpatient Services', 'Specialist Consultations', 'Health Checkups'].map((item) => (
                <li key={item}>
                  <a
                    href="#"
          ...
          <div className="flex flex-col items-start sm:items-center md:items-start">
            ...
            <ul className="space-y-1">
              {['About Us', 'Careers', 'Contact', 'News & Events'].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className={`block text-xs transition ${
          ...
          <div className="flex flex-col items-start sm:items-center md:items-start">
            ...
            <ul className="space-y-1">
              {['Privacy Policy', 'Terms of Service', 'Patient Rights', 'Data Protection'].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className={`block text-xs transition ${
