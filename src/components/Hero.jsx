      ...
      >
        ...
        <div className="hero-content text-center text-white relative z-10">
          <div className="max-w-lg">
            ...
            <button className="mt-2 px-6 py-2 font-semibold rounded-full transition duration-300 border-2  border-red-500 bg-white text-red-500 hover:bg-red-500 hover:text-white">
                Book Appointment                                                                           
            </button>
